...
export const QUICK_ANSWERS = {
  home:
    "This hub estimates break-even ROAS, max CPA, and max CPC from your margin and conversion rate. For a dedicated break even ROAS calculator, use the Break Even ROAS Calculator page — not generic 3× or 4× benchmarks.",
